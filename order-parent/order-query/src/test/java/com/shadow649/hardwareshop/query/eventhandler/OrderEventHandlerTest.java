...
public class OrderEventHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        orderEventHandler = new OrderEventHandler(service);
    }
    ...
    public void givenOrderNotExists_whenServiceGetById_ThrowOrderNotFoundException() {
        ...
        orderEventHandler.on(new OrderConfirmedEvent("id"));
    }
    ...
    public void whenAnOrderIsApproved_thenSaveProjection() {
        ...
        orderEventHandler.on(new OrderApprovedEvent("id", customerInfo, rows));
    ...
    public void whenAProductInOrderIsUpdated_thenTheUpdatedEntryIsSaved() {
        ...
        orderEventHandler.on(new OrderProductUpdatedEvent("test1", "123", "newName", new BigDecimal(1000)));
    ...
    public void whenAProductNotInTheOrderIsUpdated_thenNoUpdate() {
        ...
        orderEventHandler.on(new OrderProductUpdatedEvent("test1", "5", "newName", new BigDecimal(1000)));
